    ...
    <footer>
      ...
      <div className="bg-oren-muda px-5 py-10 text-center text-white">
        <div className="mx-auto max-w-5xl">
          <h3 className="mb-6 text-2xl font-semibold">Follow us</h3>
          <div className="flex flex-wrap items-center justify-center gap-5">
            {socialLinks.map((social) => (
              <a
                ...
                className="flex h-12 w-12 items-center justify-center rounded-full bg-ash text-lg font-semibold text-white transition-all duration-300 hover:bg-black"
              >
                {social.icon}
              </a>
            ))}
